...
const Faq = () => {
  ...
  return (
    <div className="faq-container">
      <Helmet>
        <title>FAQs | Desire4Travels - Your Travel Questions Answered</title>
        <meta
          name="description"
          content="Find answers to the most frequently asked questions about our travel packages, booking process, payments, cancellations, and more."
        />
        <meta
          name="keywords"
          content="FAQs, travel questions, trip booking, cancellation policy, travel support, Desire4Travels help"
        />
        <meta property="og:title" content="FAQs | Desire4Travels Support" />
        <meta property="og:description" content="Everything you need to know before booking your next adventure with Desire4Travels." />
      </Helmet>
