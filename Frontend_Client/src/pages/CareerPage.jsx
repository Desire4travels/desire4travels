...
const CareerPage = () => {
  return (
    <div className="career-page">
      <Helmet>
        <title>Careers at Desire4Travels | Join Our Travel Team</title>
        <meta
          name="description"
          content="Explore exciting career opportunities at Desire4Travels. Join us to grow your skills and be part of a passionate travel company."
        />
        <meta name="keywords" content="careers, jobs, travel jobs, Desire4Travels, travel careers, hiring" />
        <meta property="og:title" content="Careers at Desire4Travels | Join Our Travel Team" />
        <meta property="og:description" content="Discover current openings and apply to join the Desire4Travels team. Help create unforgettable travel experiences." />
      </Helmet>
